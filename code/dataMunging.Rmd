...
*playerPosition cointains data on players' phisical attributes and positions
```{r}
...
I found a [dataset](http://www.rugbyhow.com/2015RWC-all-player-sizes.html#AName order) with phisical measurements of players for the 2015 Rugby World Cup that also included player position. I merged the 2 datasets using player names 
```{r}
 ...
 *Cluster 3 is the largests and the best fit cluster with an average score ( s~i~ ) of 0.86
